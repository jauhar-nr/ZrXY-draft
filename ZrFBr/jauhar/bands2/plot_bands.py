...
print("Membaca data Super-Dense Band Structure untuk ZrFBr...")
...
# E = E_0 + a * k^2 -> d^2E/dk^2 = 2*a -> m* = hbar^2 / (2*a)
# Untuk hole (VBM kurva cembung ke atas, a < 0): m_h* = -hbar^2 / (2*a)
...
summary_text = f"""==================================================
Hasil Analisis Super-Dense Band Structure: ZrFBr
==================================================
...
ax.set_title(r'ZrFBr Monolayer ($E_g = ' + f'{band_gap:.2f}' + r'\ \mathrm{eV}$)', fontsize=11)
