...
for d_idx, d in enumerate(directions):
    ...
    ax_e.set_title(r'$\mathrm{ZrBr}_2$ Elastic Energy (' + d + r')')
    ...
    ax_b.set_title(r'$\mathrm{ZrBr}_2$ Deformation Potential (' + d + r')')
...
with open('DPT_results.txt', 'w') as f_out:
    f_out.write("======================================================================\n")
    f_out.write("HASIL ANALISIS DEFORMATION POTENTIAL THEORY (DPT): ZrBr2\n")
