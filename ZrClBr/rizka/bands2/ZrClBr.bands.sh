...
mpirun --use-hwthread-cpus -np $SLURM_NTASKS pw.x -nk 4 < ZrClBr.nscf.in > ZrClBr.nscf.out

# 3. Eksekusi BANDS
mpirun --use-hwthread-cpus -np $SLURM_NTASKS bands.x < ZrClBr.bands.in > ZrClBr.bands.out
