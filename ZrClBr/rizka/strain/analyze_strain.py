...
for d_idx, d in enumerate(directions):
    ...
    ax_e.set_title(f'ZrClBr Elastic Energy ({d})')
    ...
    ax_b.set_title(f'ZrClBr Deformation Potential ({d})')
...
with open('DPT_results.txt', 'w') as f_out:
    f_out.write("======================================================================\n")
    f_out.write("HASIL ANALISIS DEFORMATION POTENTIAL THEORY (DPT): ZrClBr\n")
