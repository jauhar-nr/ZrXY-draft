...
mpirun --use-hwthread-cpus -np $SLURM_NTASKS pw.x -nk 4 < ZrFCl.nscf.in > ZrFCl.nscf.out

# 3. Eksekusi BANDS
mpirun --use-hwthread-cpus -np $SLURM_NTASKS bands.x < ZrFCl.bands.in > ZrFCl.bands.out
